...
export default function AdminDashboard() {
  ...
  return (
    <>
      <AdminHeader />
      <div className="bg-[#ede9e9]  flex flex-col gap-2 justify-center items-center w-full h-[750px]">
        <div className="flex mt-[-30px] ml-[160px]">
          <div className="bg-white  w-[76vw] h-[100px] flex justify-start items-center">
            <img
            ...
            />
            <h1 className="ml-[10px] text-xl font-bold text-[#4293ef]">0</h1>
            <p className="mt-[40px] ml-[-20px] text-[10px] font-medium">
              Total Sale
            </p>
          </div>
        ...
        <div className="flex gap-[50px] mt-[9px]">
          <div className="bg-white w-[78vw] ml-[180px] h-[400px] flex justify-start  pl-5 ">
            <div className="mt-5">
